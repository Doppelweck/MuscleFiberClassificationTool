    ...
    methods
        ...
        function startResultsMode(obj,Data,InfoText)
            ...
            try
                ...
                [~,name,~] = fileparts([obj.modelResultsHandle.PathName obj.modelResultsHandle.FileName]);
        ...
        function showAxesScatterBlueRedGUI(obj)
            ...
            if ~isempty(obj.modelResultsHandle.StatsMatDataT1)
                ...
                scatter(obj.viewResultsHandle.hAScatterBlueRed,x,y,20,'MarkerEdgeColor','k','MarkerFaceColor',ColorMapAll(1,:));
            ...
            if ~isempty(obj.modelResultsHandle.StatsMatDataT12h)
                ...
                scatter(obj.viewResultsHandle.hAScatterBlueRed,x,y,20,'MarkerEdgeColor','k','MarkerFaceColor',ColorMapAll(2,:));
            ...
            if AnalyzeMode == 1 || AnalyzeMode == 3 || AnalyzeMode == 5 || AnalyzeMode == 7 %tripple labeling
                ...
                if ~isempty(obj.modelResultsHandle.StatsMatDataT2)
                    ...
                    scatter(obj.viewResultsHandle.hAScatterBlueRed,x,y,20,'MarkerEdgeColor','k','MarkerFaceColor',ColorMapAll(3,:));
                ...
                if ~isempty(obj.modelResultsHandle.StatsMatDataT2a)
                    ...
                    scatter(obj.viewResultsHandle.hAScatterBlueRed,x,y,20,'MarkerEdgeColor','k','MarkerFaceColor',ColorMapAll(4,:));
                ...
                if ~isempty(obj.modelResultsHandle.StatsMatDataT2ax)
                    ...
                    scatter(obj.viewResultsHandle.hAScatterBlueRed,x,y,20,'MarkerEdgeColor','k','MarkerFaceColor',ColorMapAll(5,:));
        ...
        function showAxesScatterFarredRedGUI(obj)
            ...
            if AnalyzeMode == 1 || AnalyzeMode == 3 || AnalyzeMode == 5 || AnalyzeMode == 7 %tripple labeling
                ...
                if ~isempty(obj.modelResultsHandle.StatsMatDataT2)
                    ...
                    scatter(obj.viewResultsHandle.hAScatterFarredRed,x,y,20,'MarkerEdgeColor','k','MarkerFaceColor',ColorMapAll(3,:));
                    LegendString{end+1} = 'Type 2';
                end
                ...
                if ~isempty(obj.modelResultsHandle.StatsMatDataT2a)
                    ...
                    scatter(obj.viewResultsHandle.hAScatterFarredRed,x,y,20,'MarkerEdgeColor','k','MarkerFaceColor',ColorMapAll(4,:));
                    LegendString{end+1} = 'Type 2a';
                end
                ...
                if ~isempty(obj.modelResultsHandle.StatsMatDataT2ax)
                    ...
                    scatter(obj.viewResultsHandle.hAScatterFarredRed,x,y,20,'MarkerEdgeColor','k','MarkerFaceColor',ColorMapAll(5,:));
                    LegendString{end+1} = 'Type 2ax';
                end
            end
            hold(obj.viewResultsHandle.hAScatterFarredRed, 'on');
